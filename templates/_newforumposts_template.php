<?php
	 ...
	 */
	 ...
	 $NEWFORUMPOSTS_TEMPLATE['default']['start']   = "<ul class='media-list list-unstyled newforumposts-menu'>{SETIMAGE: w=48&h=48&crop=1}";
	 $NEWFORUMPOSTS_TEMPLATE['default']['item']    = "<li class='media d-flex mt-3'>
	 ...
	 $NEWFORUMPOSTS_TEMPLATE['default']['end']     = "</ul>";




	 $NEWFORUMPOSTS_TEMPLATE['minimal']['start']   = "<ul class='media-list newforumposts-menu'>{SETIMAGE: w=48&h=48&crop=1}";
	 $NEWFORUMPOSTS_TEMPLATE['minimal']['item']    = "<li class='media'>
	 ...
	 $NEWFORUMPOSTS_TEMPLATE['minimal']['end']     = "</ul>";




	 $NEWFORUMPOSTS_TEMPLATE['main']['start']      = "<!-- newforumposts -->
	...
	$NEWFORUMPOSTS_TEMPLATE['main']['item']        = "<tr>
	...
	$NEWFORUMPOSTS_TEMPLATE['main']['end']         = "<tr>
